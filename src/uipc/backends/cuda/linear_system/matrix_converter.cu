...
void MatrixConverter::convert(const muda::DeviceTripletMatrix<T, N>& from,
                              muda::DeviceBCOOMatrix<T, N>&          to)
{
    Timer timer("convert3x3");
...
void MatrixConverter::_merge_sort_indices_and_blocks(const muda::DeviceTripletMatrix<T, N>& from,
                                                     muda::DeviceBCOOMatrix<T, N>& to)
{
...
void MatrixConverter::_radix_sort_indices_and_blocks(const muda::DeviceTripletMatrix<T, N>& from,
                                                     muda::DeviceBCOOMatrix<T, N>& to)
{
    using namespace muda;
...
void MatrixConverter::_radix_sort_indices_and_blocks(muda::DeviceBCOOMatrix<T, N>& to)
{
    using namespace muda;
...
void MatrixConverter::_make_unique_indices(const muda::DeviceTripletMatrix<T, N>& from,
                                           muda::DeviceBCOOMatrix<T, N>& to)
{
    using namespace muda;
...
void MatrixConverter::_make_unique_indices_and_blocks(
...
void MatrixConverter::_make_unique_blocks_task_based(const muda::DeviceTripletMatrix<T, N>& from,
                                                     muda::DeviceBCOOMatrix<T, N>& to)
{
    using namespace muda;
...
void MatrixConverter::_make_unique_block_warp_reduction(
    const muda::DeviceTripletMatrix<T, N>& from, muda::DeviceBCOOMatrix<T, N>& to)
{
    using namespace muda;
...
void MatrixConverter::_make_unique_blocks_naive(const muda::DeviceTripletMatrix<T, N>& from,
                                                muda::DeviceBCOOMatrix<T, N>& to)
{
    using namespace muda;
...
void MatrixConverter::convert(const muda::DeviceBCOOMatrix<T, N>& from,
...
void MatrixConverter::_calculate_block_offsets(const muda::DeviceBCOOMatrix<T, N>& from,
                                               muda::DeviceBSRMatrix<T, N>& to)
{
...
void MatrixConverter::ge2sym(muda::DeviceBCOOMatrix<T, N>& to)
{
    using namespace muda;
...
void MatrixConverter::sym2ge(const muda::DeviceBCOOMatrix<T, N>& from,
                             muda::DeviceBCOOMatrix<T, N>&       to)
{
    using namespace muda;
