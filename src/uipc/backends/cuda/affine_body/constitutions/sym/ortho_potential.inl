...
/* Sub Exprs */
/* Simplified Expr */
R = kappa*v*(2*std::pow((q(10)*q(4) + q(11)*q(5) + q(3)*q(9)), (2)) + 2*std::pow((q(10)*q(7) + q(11)*q(8) + q(6)*q(9)), (2)) + 2*std::pow((q(3)*q(6) + q(4)*q(7) + q(5)*q(8)), (2)) + std::pow((std::pow((q(10)), (2)) + std::pow((q(11)), (2)) + std::pow((q(9)), (2)) - 1), (2)) + std::pow((std::pow((q(3)), (2)) + std::pow((q(4)), (2)) + std::pow((q(5)), (2)) - 1), (2)) + std::pow((std::pow((q(6)), (2)) + std::pow((q(7)), (2)) + std::pow((q(8)), (2)) - 1), (2)));
}
template <typename T>
...
auto x5 = 4*std::pow((q(6)), (2)) + 4*std::pow((q(7)), (2)) + 4*std::pow((q(8)), (2)) - 4;
auto x6 = 4*std::pow((q(10)), (2)) + 4*std::pow((q(11)), (2)) + 4*std::pow((q(9)), (2)) - 4;
/* Simplified Expr */
...
auto x33 = q(4)*x32;
auto x34 = q(5)*x32;
auto x35 = std::pow((q(10)), (2));
auto x36 = 4*x35;
auto x37 = 4*x0;
auto x38 = std::pow((q(7)), (2));
auto x39 = 4*x38;
auto x40 = x37 + x39;
auto x41 = 4*q(10);
auto x42 = q(11)*x41;
...
auto x58 = std::pow((q(8)), (2));
auto x59 = 4*x58;
auto x60 = x59 - 4;
auto x61 = std::pow((q(11)), (2));
auto x62 = 4*x61;
auto x63 = x37 + x62;
auto x64 = x44*x53;
auto x65 = x11*x21;
