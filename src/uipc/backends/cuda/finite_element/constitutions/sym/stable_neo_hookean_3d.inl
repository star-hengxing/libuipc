...
template <typename T>
__host__ __device__ void dSNKdVecF(Eigen::Vector<T,9>& R, const T& mu, const T& lambda, const Eigen::Vector<T,9>& VecF)
{
/*****************************************************************************************************************************
Function generated by SymEigen.py 
Author: MuGdxy
...
template <typename T>
__host__ __device__ void ddSNKddVecF(Eigen::Matrix<T,9,9>& R, const T& mu, const T& lambda, const Eigen::Vector<T,9>& VecF)
{
/*****************************************************************************************************************************
Function generated by SymEigen.py 
Author: MuGdxy
