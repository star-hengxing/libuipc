...
class ContactModelCollection:
    ...
    def find(self, arg0: str) -> pyuipc.geometry.IAttributeSlot: ...

class ContactTabular:
    def __init__(self, *args, **kwargs) -> None: ...
    def at(self, arg0: int, arg1: int) -> ContactModel: ...
    ...
    @overload
    def default_model(self, friction_rate: float, resistance: float, enable: bool = ..., config: json = ...) -> None: ...
    @overload
    def default_model(self) -> ContactModel: ...
    def element_count(self) -> int: ...
    def insert(self, L: ContactElement, R: ContactElement, friction_rate: float, resistance: float, enable: bool = ..., config: json = ...) -> int: ...
