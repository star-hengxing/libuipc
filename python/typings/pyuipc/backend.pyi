...
class SceneVisitor:
    ...
    def __init__(self, arg0: pyuipc.world.Scene) -> None: ...
    def begin_pending(self) -> None: ...
    def constitution_tabular(self) -> pyuipc.world.ConstitutionTabular: ...
    def contact_tabular(self) -> pyuipc.world.ContactTabular: ...
